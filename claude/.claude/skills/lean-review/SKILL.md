...
## Step 6: Report
Net line delta; the final state of every list, including what was not applied and why; agent-speak deleted, rewritten, and kept; import findings fixed, escalated, or filed with URLs; veteran-unix findings left open. Nothing committed or pushed.
