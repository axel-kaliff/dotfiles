#!/usr/bin/env bash
# Ground truth for a handoff. Run explicitly by the Codex handoff skill.
...
echo "Session: ${CODEX_SESSION_ID:-unknown}"
echo "Transcript: use the Codex session record; no transcript path inferred"
